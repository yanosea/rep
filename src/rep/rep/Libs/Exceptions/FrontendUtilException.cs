...
{
    /// <summary>
    /// FrontendUtilException
    /// </summary>
    internal sealed class FrontendUtilException : Exception
    {
        #region constructor
        ...
        /// constructor
        /// </summary>
        internal FrontendUtilException() : base()
        {
        ...
        internal FrontendUtilException(string message, Exception ex,
