...
{
    /// <summary>
    /// BackendUtilException
    /// </summary>
    internal sealed class BackendUtilException : Exception
    {
        #region constructor
        ...
        /// constructor
        /// </summary>
        internal BackendUtilException() : base()
        {
        ...
        internal BackendUtilException(string message, Exception ex,
