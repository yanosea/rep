...
{
    /// <summary>
    /// create files exception
    /// </summary>
    internal sealed class CreateFilesException : Exception
    {
        #region constructor
        ...
        /// constructor
        /// </summary>
        internal CreateFilesException() : base()
        {
        ...
        internal CreateFilesException(string message, Exception ex,
