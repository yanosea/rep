...
{
    /// <summary>
    /// WriteConfigFileException
    /// </summary>
    internal sealed class WriteConfigFileException : Exception
    {
        #region constructor
        ...
        /// constructor
        /// </summary>
        internal WriteConfigFileException() : base()
        {
        ...
        internal WriteConfigFileException(string message, Exception ex,
