...
{
    /// <summary>
    /// ReadSqliteDBFileException
    /// </summary>
    internal sealed class ReadSqliteDBFileException : Exception
    {
        #region constructor
        ...
        /// constructor
        /// </summary>
        internal ReadSqliteDBFileException() : base()
        {
        ...
        internal ReadSqliteDBFileException(string message, Exception ex,
