...
{
    /// <summary>
    /// WriteSqliteDBFileException
    /// </summary>
    internal sealed class WriteSqliteDBFileException : Exception
    {
        #region constructor
        ...
        /// constructor
        /// </summary>
        internal WriteSqliteDBFileException() : base()
        {
        ...
        internal WriteSqliteDBFileException(string message, Exception ex,
